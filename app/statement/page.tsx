...
export const metadata = { title: 'Declaracion — Victoria Ruiz Diaz' }

export default function StatementPage() {
  return (
    <InnerLayout activePage="statement">
      <section className="inner-stage" aria-label="Declaracion">
        <header className="inner-header">
          <h3 className="inner-heading">Declaracion</h3>
        </header>
